...
__all__ = ["SimulationLoopFourierNLSE"]


class SimulationLoopFourierNLSE(SimulationLoop):
    ...
    def prepare_simulation(self):
        ...
        self.propagator = FourierPropagatorNLSE(potential, initialvalues, self.parameters)
